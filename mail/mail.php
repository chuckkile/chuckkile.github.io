...
$sendingAccountUsername     = 'chuck@murrayhillremodeling.com';
$sendingAccountPassword     = 'murrayhill778';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'patrick@murrayhillremodeling.com'; // REQUIRED value.
$ccRecipientEmail             = 'chuck.kile@gmail.com'; // REQUIRED value.
$recipientName              = 'Patrick Richardson';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'CONTACT FORM SUBMISSION'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Murrayhill Remodeling';                // REQUIRED value. This is used when a name or email is not collected from the website form
