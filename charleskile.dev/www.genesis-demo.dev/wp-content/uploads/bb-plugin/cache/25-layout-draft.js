...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='http://www.genesis-demo.dev/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.genesis-demo.dev/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://www.genesis-demo.dev/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://www.genesis-demo.dev/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);(function($){if($(window).width()<=768&&$(window).width()>=481){$('.fl-node-59d7e24eda121 .pp-heading-separator, .fl-node-59d7e24eda121 .pp-heading').removeClass('pp-center');$('.fl-node-59d7e24eda121 .pp-heading-separator, .fl-node-59d7e24eda121 .pp-heading').addClass('pp-tablet-center');}
if($(window).width()<=480){$('.fl-node-59d7e24eda121 .pp-heading-separator, .fl-node-59d7e24eda121 .pp-heading').removeClass('pp-center');$('.fl-node-59d7e24eda121 .pp-heading-separator, .fl-node-59d7e24eda121 .pp-heading').addClass('pp-mobile-center');}})(jQuery);(function($){window.onLoadFLReCaptcha=function(){var reCaptchaFields=$('.fl-grecaptcha'),widgetID;if(reCaptchaFields.length>0){reCaptchaFields.each(function(){var self=$(this),attrWidget=self.attr('data-widgetid');if((typeof attrWidget!==typeof undefined&&attrWidget!==false)){return;}
else{widgetID=grecaptcha.render($(this).attr('id'),{sitekey:self.data('sitekey'),theme:'light',callback:function(response){if(response!=''){self.attr('data-fl-grecaptcha-response',response);}}});self.attr('data-widgetid',widgetID);}});}};FLBuilderContactForm=function(settings)
...
if(reCaptchaField.length>0){if('undefined'===typeof reCaptchaValue||reCaptchaValue===false){isValid=false;reCaptchaField.parent().addClass('fl-error');}else{reCaptchaField.parent().removeClass('fl-error');}}
...
$(this.nodeClass+' .fl-send-error').fadeIn();return false;}}};})(jQuery);(function($){$(function(){new FLBuilderContactForm({id:'59d3e2733ef73'});});})(jQuery);;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();