...
{$('body').off('uabb-trigger.'+hook,callback);},};})(jQuery);jQuery(document).ready(function($){var uabb_browser=bowser.name,uabb_browser_v=bowser.version,uabb_browser_class=uabb_browser.replace(/\s+/g,'-').toLowerCase(),uabb_browser_v_class=uabb_browser_class+parseInt(uabb_browser_v);$('html').addClass(uabb_browser_class).addClass(uabb_browser_v_class);});var wpAjaxUrl='http://www.webdesign.dev/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.webdesign.dev/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://www.webdesign.dev/wp-content/plugins/bb-plugin/',wpAjaxUrl:'http://www.webdesign.dev/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
if($(this.wrapperClass).hasClass('fl-menu-accordion-collapse')){if(!$link.parents('.menu-item').hasClass('fl-active')){$('.fl-active',this.wrapperClass).not($link).removeClass('fl-active');}
else if($link.parents('.menu-item').hasClass('fl-active')&&$link.parent('.sub-menu').length){$('.fl-active',this.wrapperClass).not($link).not($activeParent).removeClass('fl-active');}
...
var module=$(this.nodeClass),clone=$(this.nodeClass+'-clone'),menu=clone.find('ul.menu');module.find('.fl-menu-mobile-toggle').after(menu);clone.remove();}};})(jQuery);(function($){$(function(){new FLBuilderMenu({id:'59cea7065e5de',type:'horizontal',mobile:'hamburger',mobileBelowRow:false,breakPoints:{medium:992,small:768},mobileBreakpoint:'mobile'});});})(jQuery);(function($){$(function(){new FLBuilderMenu({id:'59cea75058d8a',type:'horizontal',mobile:'hamburger',mobileBelowRow:false,breakPoints:{medium:992,small:768},mobileBreakpoint:'mobile'});});})(jQuery);(function($){$('.fl-node-59cae313ed29b .fl-slider-next').empty();$('.fl-node-59cae313ed29b .fl-slider-prev').empty();$('.fl-node-59cae313ed29b .fl-testimonials').bxSlider({autoStart:1,auto:true,adaptiveHeight:true,pause:4000,mode:'fade',autoDirection:'next',speed:1000,pager:1,nextSelector:'.fl-node-59cae313ed29b .fl-slider-next',prevSelector:'.fl-node-59cae313ed29b .fl-slider-prev',nextText:'<i class="fa fa-chevron-circle-right"></i>',prevText:'<i class="fa fa-chevron-circle-left"></i>',controls:0,onSliderLoad:function(){$('.fl-node-59cae313ed29b .fl-testimonials').addClass('fl-testimonials-loaded');},onSliderResize:function(currentIndex){this.working=false;this.reloadSlider();},onSlideBefore:function(ele,oldIndex,newIndex){$('.fl-node-59cae313ed29b .fl-slider-next a').addClass('disabled');$('.fl-node-59cae313ed29b .fl-slider-prev a').addClass('disabled');$('.fl-node-59cae313ed29b .bx-controls .bx-pager-link').addClass('disabled');},onSlideAfter:function(ele,oldIndex,newIndex){$('.fl-node-59cae313ed29b .fl-slider-next a').removeClass('disabled');$('.fl-node-59cae313ed29b .fl-slider-prev a').removeClass('disabled');$('.fl-node-59cae313ed29b .bx-controls .bx-pager-link').removeClass('disabled');},});})(jQuery);